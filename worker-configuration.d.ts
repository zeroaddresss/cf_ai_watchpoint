/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6e89649b68557a5fb8c9b5be8e91dbd5)
// Runtime types generated with workerd@1.20260301.1 2026-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "WatchAgent" | "WatchpointMcpAgent";
	}
	interface Env {
		BROWSER: Fetcher;
		AI: Ai;
		ASSETS: Fetcher;
		WATCHPOINT_AI_GATEWAY_ID: "";
		WATCHPOINT_CAPTURE_MODE: "browser";
		WATCHPOINT_DEV_PAYMENT_BYPASS: "watchpoint-local-paid";
		WATCHPOINT_FACILITATOR_URL: "https://x402.org/facilitator";
		WATCHPOINT_USE_WORKERS_AI: "true";
		WATCHPOINT_X402_NETWORK: "eip155:84532";
		WATCHPOINT_X402_PAY_TO: "0x1111111111111111111111111111111111111111";
		WATCH_AGENT: DurableObjectNamespace<import("./src/index").WatchAgent>;
		WATCHPOINT_MCP: DurableObjectNamespace<import("./src/index").WatchpointMcpAgent>;
		WATCH_WORKFLOW: Workflow<Parameters<import("./src/index").WatchWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WATCHPOINT_AI_GATEWAY_ID" | "WATCHPOINT_CAPTURE_MODE" | "WATCHPOINT_DEV_PAYMENT_BYPASS" | "WATCHPOINT_FACILITATOR_URL" | "WATCHPOINT_USE_WORKERS_AI" | "WATCHPOINT_X402_NETWORK" | "WATCHPOINT_X402_PAY_TO">> {}
}
